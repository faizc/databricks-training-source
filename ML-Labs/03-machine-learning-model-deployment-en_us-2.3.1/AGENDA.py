...
# MAGIC | 4 | **[Real-time Deployment and Online Stores]($./M04 - Real-time Deployment and Online Stores)** | • *Lecture:* Introduction to Real-time Deployment <br> • *Lecture:* Model Serving <br> • [**Demo:** Real-time Deployment with Model Serving]($./M04 - Real-time Deployment and Online Stores/4.1 Demo - Real-time Deployment with Model Serving) <br> • [**Demo:** Custom Model Deployment with Model Serving]($./M04 - Real-time Deployment and Online Stores/4.2 Demo - Custom Model Deployment with Model Serving) <br> • [**Lab:** Real-time Deployment with Model Serving]($./M04 - Real-time Deployment and Online Stores/4.3 Lab - Real-time Deployment with Model Serving) |
# MAGIC
# MAGIC
# MAGIC
# MAGIC ---
